...
SELECT count(*) as "Numero de productos", categories.CategoryName FROM categories, products  where categories.CategoryID = products.CategoryID and categories.CategoryID =3 or categories.CategoryID =5 or categories.CategoryID =8 group by categories.CategoryName; 
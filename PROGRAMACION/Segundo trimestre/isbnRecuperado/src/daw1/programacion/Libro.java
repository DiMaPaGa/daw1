...
public class Libro {
    ...
    public Libro(String isbn, String titulo, String autor) throws Exception {
        this();
        setIsbn(isbn);
        setTitulo(titulo);
        setAutor(autor);
    ...
    public Libro(String isbn, String titulo, String autor, int numeroPaginas, String editorial) throws Exception {
